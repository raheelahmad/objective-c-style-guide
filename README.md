...
`NSString`, `NSDictionary`, `NSArray`, and `NSNumber` literals should be used whenever creating immutable instances.

Put a space between the outer `[ ]` and `{ }`.
